...
// Like testRSACertificate above, but using rsaPSS OID on the inner PublicKey,
// creating a certificate usable with rsa_pss_pss_* SignatureSchemes. Using
// the same testRSAPrivateKey.
//
// Since testRSACertificateIssuer wasn't included, signed by the below
// testRSAPSSOIDCertificateIssuer.
//
// Generated via:
//
// openssl req -key leaf.key -new -x509 -CA ca.pem -CAkey ca.key -days $(( ( $(date -d '2025-01-01' -u +%s) - $(date -u +%s) ) / (3600 * 24) + 1 )) -out leaf.pem -config config -extensions leaf_exts
//
// Config:
//
// [ req ]
...
// subjectAltName = DNS:example.golang
var testRSAPSSOIDCertificate = fromHex("")

// Generated via:
//
// openssl genpkey -algorithm rsa-pss -pkeyopt rsa_keygen_bits:2048 -out ca.key
// openssl req -key ca.key -new -x509 -days $(( ( $(date -d '2025-01-01' -u +%s) - $(date -u +%s) ) / (3600 * 24) + 1 ))  -out ca.pem -config config -extensions ca_exts
//
// Config:
//
// [ req ]
...
// [ ca ]
// organizationName = Go
// commonName = Go Root PSS
//
// [ ca_exts ]
// extendedKeyUsage = serverAuth,clientAuth
// keyUsage = keyCertSign
// basicConstraints=critical,CA:TRUE
var testRSAPSSOIDCertificateIssuer = fromHex("")
...
// A pre-marshalled PKCS8 variant of testRSAPrivateKey but with rsaPSS OID
// in the PKCS8 structure.
var testRSAPrivateKeyPSSPKCS8 = fromHex("")
